...
def get_symbol(num_classes, **kwargs):
    ...
    # top_left = conv(top_left, num_filter=out_channels[4], kernel_size=(3,3), stride=(1,1), pad=(1,1))  # (7x7)
    # top_right = conv(top_right, num_filter=out_channels[4], kernel_size=(3,3), stride=(1,1), pad=(1,1))  # (7x7)
    # bottom_left = conv(bottom_left, num_filter=out_channels[4], kernel_size=(3,3), stride=(1,1), pad=(1,1))  # (7x7)
    # bottom_right = conv(bottom_right, num_filter=out_channels[4], kernel_size=(3,3), stride=(1,1), pad=(1,1))  # (7x7)
    ...
    # data = mx.sym.concat(top_left, top_right, bottom_left, bottom_right, data, dim=1)
