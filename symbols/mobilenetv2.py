...
MNETV2_CONFIGS_MAP = {
    ...
    (48,64):{
        'firstconv_filter_num': 32, # 3*48*64 -> 32*24*32
        # t, c, n, s
        'bottleneck_params_list':[
            (1, 16, 1, 1), # 32x24x32 -> 16x24x32
            (6, 24, 2, 2), # 16x24x32 -> 24x12x16
            (6, 32, 3, 2), # 24x12x16 -> 32x6x8
            (6, 64, 4, 2), # 32x6x8 -> 64x3x4
        ],
        'filter_num_before_gp': 1280, # 320x3x4 -> 1280x3x4
    } 
}
...
def get_symbol(num_classes, **kwargs):
    multiplier=1.0
    mnetgen = MNetV2Gen((48,64), multiplier=multiplier)
